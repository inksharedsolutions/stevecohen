            ...
            <footer className="footer-section">
                <div className="footer-container footer-grid">
                    <div className="footer-child footer-paragraph-info">
                        ...
                        <p>
                            S. M. Cohen and L. J. Altman loves to hear from readers. You can reach him via email.
                        ...
                        <nav className="social-media-nav">
                            <ul>
                                ...
                                <li>
                                    <a
                                        target="_blank"
                                        href="https://www.goodreads.com/book/show/55515356-from-bullying-to-sexual-violence"
                                        rel="noreferrer"
                                    >
